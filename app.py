...
class Bank:
    bank_name = "Summit Bank"  # Class variable shared by all instances
...
# Create an object
emp = Employee("Anu", 50000, "123-45-6789")
...
# Example usage
emp1 = Employee("Anam", "Manager")
emp2 = Employee("Noman", "Developer")
...
# print(product.price)  # This will raise an AttributeError because the price is deleted
...
# Example usage: creating a Countdown object starting from 5
